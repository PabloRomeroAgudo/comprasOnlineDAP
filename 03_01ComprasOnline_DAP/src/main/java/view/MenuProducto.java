...
public class MenuProducto extends JDialog implements ActionListener, KeyListener, MouseListener {

	private static final long serialVersionUID = 1L;
	
	private static final String TITULO = "AMADEOZON - PRODUCTOS";
	...
	public MenuProducto(Window parent) {
		this.setModal(true);
		setUndecorated(true);
		setResizable(false);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (findByName == e.getSource()) {
			...
			opcion = 3;
			instruccionesLabel.setText("Introduce el nuevo producto en formato JSON:");
			eYSTexto.setEditable(true);
			eYSTexto.setText("");
		} else if (update == e.getSource()) {
			opcion = 4;
			instruccionesLabel.setText("Introduce el producto que quieras modificar en formato JSON:");
			eYSTexto.setEditable(true);
			eYSTexto.setText("");
		} else if (delete == e.getSource()) {
			opcion = 5;
			instruccionesLabel.setText("Introduce el id del objeto a borrar:");
			eYSTexto.setEditable(true);
			eYSTexto.setText("");
