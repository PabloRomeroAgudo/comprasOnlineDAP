...
public class ProductoDAOImpl implements ProductoDAO {
	...
	public String findAll() {
		...
		try {
			...
			System.err.println("Error en findAll de Productos");
		} finally {
		     cursor.close();
		}
	...
	public String findByName(String init) {
		...
		try {
			...
			System.err.println("Error en findByName de Productos");
		} finally {
		     cursor.close();
		}
	...
	public String findById(Integer id) {
		...
		try {
		     if (cursor.hasNext()) {
		    	 producto = Utils.pretty(cursor.next().toJson());
		     }
		} catch (Exception e) {
			System.err.println("Error en findById de Productos");
		} finally {
		     cursor.close();
		}
	...
	public Boolean delete(Integer id) {
		try {
			...
			System.err.println("Error en delete de Productos");
			return false;
		}
